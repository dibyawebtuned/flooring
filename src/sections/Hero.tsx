                ...
                <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10 lg:px-[80px] flex flex-col lg:flex-row">
                    ...
                    <div className="flex-2 pb-8 sm:pb-10 lg:pb-[50px]">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                            <button className="px-5 py-3 sm:px-[20px] sm:py-[11px] bg-[#F6F4EF] text-black font-semibold rounded-[4px] hover:bg-[#c1a37c] transition-colors">
                                Know More
                            </button>

                            <button className="px-5 py-3 sm:px-[20px] sm:py-[11px] bg-transparent border border-white text-white font-semibold rounded-[4px] hover:bg-white hover:text-black transition-colors">
                                Contact Us
                            </button>
                        </div>
                    </div>
