    ...
    return (
        <div>
            ...
            <HeroBanner
                ...
                title="Professional Floor Sanding & Polishing Services"
                description="Restore the natural beauty of your timber floors with our expert sanding and polishing solutions. We remove scratches, stains, and wear, delivering a smooth, durable, and beautifully finished surface that enhances the warmth and character of your space."
            />
                        ...
                        <div className='space-y-4'>
                            ...
                            <ul className="space-y-2 text-[#464646] text-sm sm:text-base">
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Restores Natural Timber Beauty
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Removes Scratches, Stains & Imperfections
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Extends Floor Lifespan
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Enhances Durability & Protection
                                </li>
                                <li className="flex items-center gap-2">
