    ...
    return (
        <div>
            ...
            <HeroBanner
                ...
                title="Professional Limewashing Services"
                description="Transform your timber floors with a soft, contemporary limewashed finish that enhances natural textures while creating a light, elegant aesthetic. Our professional limewashing solutions deliver a stylish, breathable coating that complements modern and coastal interiors."
            />
                    ...
                    <div className='lg:col-span-8 space-y-8 md:space-y-10'>
                        ...
                        <div className='space-y-4'>
                            ...
                            <p className='text-[#464646] text-sm sm:text-base leading-relaxed'>
                                Limewashing creates a soft, natural finish that enhances the texture and character
                                of timber flooring while delivering a contemporary, light-toned aesthetic. This breathable
                                coating not only modernises existing floors but also adds a subtle, elegant appearance
                                that complements both coastal and minimalist interior styles.
                            </p>

                            <ul className="space-y-2 text-[#464646] text-sm sm:text-base">
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Soft, Natural Aesthetic
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Enhances Timber Texture & Character
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Modern & Light-Toned Finish
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Breathable, Durable Coating
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Ideal for Coastal & Contemporary Interiors
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-5'>
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        We evaluate your flooring condition to determine the best limewashing approach
                                        for a smooth and consistent finish.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        Professional preparation ensures the timber surface is clean and ready for
                                        optimal limewash adhesion and an even finish.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent sm:col-span-2 md:col-span-1'>
                                ...
                                <div>
                                    <h5 className='text-base sm:text-lg font-semibold space-grotesk'>
                                        Limewashing Application
                                    </h5>
                                    <p className='text-sm text-[#555] mt-1'>
                                        Our expert team applies premium limewash coatings with precision, delivering
                                        a refined, durable, and beautifully textured finish.
                                    </p>
                                </div>
                            </div>
                        </div>
