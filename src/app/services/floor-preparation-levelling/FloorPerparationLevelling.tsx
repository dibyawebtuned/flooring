...
import Image_Three from "../../../../public/assets/img/WhatsApp Image 2026-02-16 at 10.52.17 AM.jpeg";
import Image_Four from "../../../../public/assets/img/WhatsApp Image 2026-02-16 at 10.52.11 AM.jpeg";
import Image_Five from "../../../../public/assets/img/WhatsApp Image 2026-02-16 at 10.52.01 AM.jpeg";

const FloorPerparationLevelling = () => {
    return (
        <div>
            {/* HERO BANNER */}
            <HeroBanner
                backgroundImage={Banner_Image.src}
                title="Professional Floor Preparation & Levelling"
                description="Ensure a flawless flooring finish with our expert floor preparation and levelling services. We correct uneven surfaces, repair subfloors, and create a smooth, stable foundation to guarantee long-lasting performance and precision installation."
            />
                    ...
                    <div className='lg:col-span-8 space-y-8 md:space-y-10'>
                        ...
                        <div className='space-y-4'>
                            <h4 className='text-xl sm:text-2xl lg:text-3xl font-semibold space-grotesk'>
                                Benefits of Floor Preparation & Levelling
                            </h4>

                            <p className='text-[#464646] text-sm sm:text-base leading-relaxed'>
                                Proper floor preparation and levelling are essential for achieving a flawless and
                                long-lasting flooring installation. Our team corrects uneven subfloors, removes
                                imperfections, and ensures a stable, smooth surface that prevents future movement,
                                cracking, or damage — creating the perfect foundation for any flooring type.
                            </p>

                            <ul className="space-y-2 text-[#464646] text-sm sm:text-base">
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Creates a Smooth, Even Surface
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Prevents Future Flooring Damage
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Improves Installation Accuracy
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Enhances Structural Stability
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Ensures Long-Term Performance
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-5'>
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        We thoroughly assess the condition of your subfloor to identify uneven areas,
                                        moisture issues, or structural concerns before installation begins.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        Grinding, filling, and levelling compounds are applied to correct irregularities
                                        and create a perfectly even base.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent sm:col-span-2 md:col-span-1'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        We complete precision levelling and finishing to ensure your floor is fully
                                        prepared for seamless and long-lasting flooring installation.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default FloorPerparationLevelling