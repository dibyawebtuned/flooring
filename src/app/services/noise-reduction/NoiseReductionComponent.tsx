    ...
    return (
        <div>
            ...
            <HeroBanner
                ...
                title="Professional Noise Reduction Flooring Solutions"
                description="Create a quieter and more comfortable environment with our advanced noise-reduction flooring solutions. Designed to minimise sound transmission and enhance acoustic performance, our solutions are ideal for residential apartments, offices, and multi-level buildings."
            />
                    ...
                    <div className='lg:col-span-8 space-y-8 md:space-y-10'>
                        ...
                        <div className='space-y-4'>
                            ...
                            <p className='text-[#464646] text-sm sm:text-base leading-relaxed'>
                                Noise-reduction flooring solutions are designed to minimise sound transmission and
                                enhance acoustic comfort in residential and commercial spaces. By reducing impact
                                noise and airborne sound, these solutions create quieter environments, improving
                                privacy and overall livability in multi-level buildings and busy households.
                            </p>

                            <ul className="space-y-2 text-[#464646] text-sm sm:text-base">
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Reduces Impact & Airborne Noise
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Enhances Acoustic Comfort
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Improves Privacy Between Spaces
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Ideal for Apartments & Multi-Level Buildings
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Compatible with Various Flooring Types
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-5'>
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        We evaluate your space to identify noise transmission issues and determine the most effective noise-reduction solution.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    <h5 className='text-base sm:text-lg font-semibold space-grotesk'>
                                        Acoustic Solution Design
                                    </h5>
                                    <p className='text-sm text-[#555] mt-1'>
                                        A tailored noise-reduction plan is developed to optimise sound insulation and improve acoustic performance.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent sm:col-span-2 md:col-span-1'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        Our expert team installs acoustic solutions with precision, ensuring effective noise reduction and long-term performance.
                                    </p>
                                </div>
                            </div>
                        </div>
