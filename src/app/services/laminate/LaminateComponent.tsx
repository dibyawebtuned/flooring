    ...
    return (
        <div>
            ...
            <HeroBanner
                ...
                title="Professional Laminate Flooring Solutions"
                description="Discover stylish and durable laminate flooring that combines modern aesthetics with exceptional practicality. Our high-quality laminate options offer a cost-effective, low-maintenance solution with a wide range of designs to suit any interior."
            />
                    ...
                    <div className='lg:col-span-8 space-y-8 md:space-y-10'>
                        ...
                        <div className='space-y-4'>
                            ...
                            <p className='text-[#464646] text-sm sm:text-base leading-relaxed'>
                                Laminate flooring is a modern, durable, and cost-effective solution that replicates the appearance of natural timber while offering superior resistance to scratches, stains, and everyday wear. With a wide range of designs and finishes, laminate provides a stylish and practical flooring option for both residential and commercial spaces.
                            </p>

                            <ul className="space-y-2 text-[#464646] text-sm sm:text-base">
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Scratch & Stain Resistant Surface
                                </li>
                                <li className="flex items-center gap-2">
                                ...
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Low Maintenance & Easy to Clean
                                </li>
                                <li className="flex items-center gap-2">
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-5'>
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        We help you choose the ideal laminate style and finish to suit your design preferences and performance needs.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        Proper subfloor preparation ensures stability and long-term performance of your laminate flooring installation.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent sm:col-span-2 md:col-span-1'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        Our skilled team installs laminate flooring with precision, delivering a seamless and durable finish.
                                    </p>
                                </div>
                            </div>
                        </div>
