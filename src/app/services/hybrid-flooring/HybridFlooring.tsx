    ...
    return (
        <div>
            ...
            <HeroBanner
                ...
                title="Premium Hybrid Flooring Solutions"
                    ...
                    <div className='lg:col-span-8 space-y-8 md:space-y-10'>
                        ...
                        <div className='space-y-4'>
                            ...
                            <p className='text-[#464646] text-sm sm:text-base leading-relaxed'>
                                Hybrid flooring combines the durability of vinyl with the refined appearance of timber,
                                delivering a water-resistant, scratch-resistant, and low-maintenance flooring solution.
                                Perfect for modern homes and commercial spaces, hybrid floors provide long-lasting performance
                                and contemporary style with minimal upkeep.
                            </p>

                            <ul className="space-y-2 text-[#464646] text-sm sm:text-base">
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Water-Resistant & Durable
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Scratch-Resistant Surface
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Timber-Look Aesthetic
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Low Maintenance & Easy to Clean
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Ideal for Residential & Commercial Spaces
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-5'>
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        Professional surface preparation ensures optimal installation and long-term
                                        durability for a flawless finish.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        We help you choose the ideal hybrid flooring style and specification to suit
                                        your space and performance requirements.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent sm:col-span-2 md:col-span-1'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        Our skilled installers deliver precision installation for a seamless and
                                        high-performance hybrid flooring solution.
                                    </p>
                                </div>
                            </div>
                        </div>
