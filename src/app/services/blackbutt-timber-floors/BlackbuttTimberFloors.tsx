...
import Image_Three from "../../../../public/assets/img/bannerimage2.jpg";
import Image_Four from "../../../../public/assets/img/WhatsApp Image 2026-02-16 at 10.52.17 AM.jpeg";
import Image_Five from "../../../../public/assets/img/WhatsApp Image 2026-02-16 at 10.52.00 AM.jpeg";

const BlackbuttTimberFloors = () => {
    return (
        <div>
            {/* HERO BANNER */}
            <HeroBanner
                backgroundImage={Banner_Image.src}
                title="Premium Blackbutt Timber Flooring"
                description="Experience the natural strength and timeless beauty of Blackbutt timber flooring. Known for its durability and warm, elegant appearance, Blackbutt flooring is an excellent choice for both residential and commercial spaces, delivering long-lasting performance and refined style."
            />
                    ...
                    <div className='lg:col-span-8 space-y-8 md:space-y-10'>
                        ...
                        <div className='space-y-4'>
                            <h4 className='text-xl sm:text-2xl lg:text-3xl font-semibold space-grotesk'>
                                Benefits of Blackbutt Timber Flooring
                            </h4>
                            ...
                            <p className='text-[#464646] text-sm sm:text-base leading-relaxed'>
                                ...
                                As one of Australia’s most durable hardwoods, it offers excellent resistance to wear while
                                providing a light, elegant aesthetic that complements both modern and traditional interiors.
                                Its longevity and refinishing potential make it a valuable investment for any space.
                            </p>

                            <ul className="space-y-2 text-[#464646] text-sm sm:text-base">
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Exceptional Durability & Strength
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Natural, Elegant Aesthetic
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Long-Lasting Performance
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Easy to Maintain & Refinish
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="text-gray-600">✔</span> Adds Value to Residential & Commercial Properties
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-5'>
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        We help you choose the ideal Blackbutt timber grade and finish to suit your design preferences and performance needs.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        Proper subfloor preparation ensures stability and a flawless installation for long-term durability and performance.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-3 rounded-xl bg-gray-50/50 p-4 sm:p-0 sm:bg-transparent sm:col-span-2 md:col-span-1'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-[#555] mt-1'>
                                        Our expert team installs Blackbutt timber flooring with precision, delivering a seamless and premium finish.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default BlackbuttTimberFloors